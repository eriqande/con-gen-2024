...
Conservation Genomics Workshop, Thursday August 29, 2024
:::
...
I am presenting, here, the approach for Snakemake versions less than 8.0.
For Snakemake versions >= 8.0 there are some slight modifications.
See [the expanded explanation, in my online bioinformatic book](https://eriqande.github.io/con-gen-csu/nmfs-bioinf/snakemake-embellishments.html#running-snakemake-on-a-cluster-resources-profiles-and-benchmarks).
